    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">  
                <li ><a href="vouchers.jsp">All Vouchers</a></li>
                <li class="active"><a href="vouchersadd.jsp">Add Vouchers</a></li>
          </ul>
        </li>
    ...
    <section class="content">
        ...
        <div style="margin-top: 50px;" class="row form-group">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="vtitle" required/>
            </div>
            <div align="center" style="" class="col-md-4 center">
            </div>   
        </div>
         ...
         <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="vamount" required/>
            </div>
            <div align="center" style="" class="col-md-4 center">
            </div>
        </div>
        <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-4">
                <label for="vshopamount">Shop Amount</label>
                <input type="text" class="form-control" id="vshopamount" required/>
            </div>
            <div align="center" style="" class="col-md-4 center">
            </div>
        </div>
        ...
        <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-4">
                ...
                <textarea class="form-control" rows="3" id="vdescription" required></textarea>
            </div>
            <div align="center" style="" class="col-md-4 center">
            </div>   
        </div>    
        ...
        <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-4">
                <label for="maincatvisible">Visible</label>
                   <div class="radio">
                     <label><input type="radio" name="maincatvisible">Yes</label>
                   </div>
                   <div class="radio">
                     <label><input type="radio" name="maincatvisible">No</label>
                   </div>    
            </div>
            <div align="center" style="" class="col-md-4 center">
            </div>   
