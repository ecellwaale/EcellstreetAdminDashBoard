    ...
    <section class="content-header">
      <h1> 
        ...
        <small>Brand Management</small>
            ...
            <div class="col-md-2">
                <form action="productaddbrandadd.jsp">
                    <input type="submit" value="Add New Brand" class="btn btn-success form-control" />
                </form>
            </div>
            <div class="col-md-2">
    ...
    <div class="container">
      <table id="example" class="display nowrap" width="100%" cellspacing="0">
        <thead>
          ...
          <tbody id="tabbrand" name="tabbrand">
   <script src="plugins/jQuery/jquery-2.2.3.min.js"></script>

    <script>
        $(document).ready(function(){
        $.ajax({url:"http://localhost:8084/Brand",
            method:"POST",
            success: function (data, textStatus, jqXHR) {
                        ...
                        $("#tabbrand").append("<tr><td>"+j[i].Scid+"</td><td>"+j[i].Title+"<td>"+j[i].ImageName+"</td><td>"+j[i].SortOrder+"</td><td>"+j[i].Visible+"</td><td><input type='button' class='btn btn-primary btn-sm' value='Modify'></td><td><input type='button' class='btn btn-danger btn-sm' value='Remove'></td></tr>");
                        }
                    },
