...
<div class="wrapper">
        ...
        <li class="treeview active">
            <a href="products.jsp"><i class="fa fa-cubes"></i> <span>Products</span><span class="pull-right-container">
             ...
             <ul class="treeview-menu">
                 ...
                 <li class="active"><a href="productaddmaincat.jsp">Main Category</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content form-group">
       ...
       <form action="Maincat" name="maincatform" id="maincatform" method="POST">
             
        <div style="margin-top: 50px;" class="row form-group">
            <div align="center" style="" class="col-md-4 center">
            </div>   
            <div class="col-md-4">
                <label for="maincat">Title</label>
                <input type="text" class="form-control" name="maincattitle" id="maincattitle" required/>
            </div>
            <div align="center" style="" class="col-md-4 center">
            </div>   
        </div>
        <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-4">
                <label for="maincatimage">Image Name</label>
                <input type="text" class="form-control" id="maincatimage" name="maincatimage" required/>
            </div>
            <div align="center" style="" class="col-md-4 center">
            </div>   
        </div>    
        <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-4">
                ...
                <input type="number" class="form-control" name="maincatsortorder" id="maincatsortorder" required/>
            </div>
            <div align="center" style="" class="col-md-4 center">
            </div>   
        </div>
        <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-4">
                <label for="maincatvisible">Visible</label>
                   <div class="radio">
                       <label><input type="radio" name="maincatvisible" value="1">Yes</label>
                   </div>
                   <div class="radio">
                       <label><input type="radio" name="maincatvisible" value="0">No</label>
                   </div>
        ...
        <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-2">
                <input type="submit" value="Add" class="btn btn-success form-control" id="addmainbut" name="addmainbut"/>
            </div>
            <div class="col-md-3">
                <a href="productaddsubcat.jsp" class="btn btn-primary form-control" role="button">Add New Sub Category</a>
            </div>
            <div class="col-md-1">
