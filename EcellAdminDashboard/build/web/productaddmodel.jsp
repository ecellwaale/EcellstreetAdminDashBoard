    ...
    <section class="content-header">
      <h1> 
        ...
        <small>Model Management</small>
            ...
            <div class="col-md-2">
                <form action="productaddmodeladd.jsp">
                    <input type="submit" value="Add New Model" class="btn btn-success form-control" />
                </form>
            </div>
            <div class="col-md-2">
                <form action="productaddproduct.jsp">
                    <input type="submit" value="Add Products" class="btn btn-primary form-control" />
                </form>
            </div>
        </div>
      </h1>
    ...
    <div class="container">
     <table id="example" class="display nowrap" width="100%" cellspacing="0">
        <thead>
          ...
          <tbody id="tabmodel" name="tabmodel">
    ...
    <script>
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                        ...
                        $("#tabmodel").append("<tr><td>"+j[i].Mid+"<td>"+j[i].Title+"</td><td>"+j[i].ImageName+"</td><td>"+j[i].SortOrder+"</td><td>"+j[i].Visible+"</td><td><input type='button' class='btn btn-primary btn-sm' value='Modify'></td><td><input type='button' class='btn btn-danger btn-sm' value='Remove'></td></tr>");
                        }
                    },
