...
<%@page import="classes.productmaincat"%>
        ...
        <li class="treeview active">
            <a href="products.jsp"><i class="fa fa-cubes"></i> <span>Products</span><span class="pull-right-container">
             ...
             <ul class="treeview-menu">
                 ...
                 <li  class="active"><a href="productaddsubcat.jsp">Sub Category</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content form-group">
        ...
        <form action="Subcat" method="post">
            ...
            <div class="col-md-4">
                <label for="maincatforsubcat">Select Main Category</label>
                <select class="form-control" name="maincatforsubcat" id="maincatforsubcat">
        ...
        <div style="margin-top: 50px;" class="row form-group">
            ...
            <div class="col-md-4">
                <label for="subcat">Title</label>
                <input type="text" class="form-control" name="subcattitle" id="subcattitle" required/>
            </div>
            <div align="center" style="" class="col-md-4 center">
            </div>   
        </div>
        <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-4">
                <label for="subcatsortorder">Sort Order</label>
                <input type="number" class="form-control" name="subcatsortorder" id="subcatsortorder" required/>
            </div>
            <div align="center" style="" class="col-md-4 center">
            </div>   
        </div>
        <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-4">
                <label for="subcatvisible">Visible</label>
                   <div class="radio" name="subcatvisible" id="subcatvisible">
                     <label><input type="radio" value="1" name="subcatvisible">Yes</label>
                   </div>
                   <div class="radio">
                     <label><input type="radio" value="0" name="subcatvisible">No</label>
                   </div>
        ...
        <div style="margin-top: 10px;" class="row form-group">
            ...
            <div class="col-md-2">
                <input type="submit" name="addsubbut" id="addsubbut" value="Add" class="btn btn-success form-control" />
            </div>
            <div class="col-md-3">
                <a href="productaddbrand.jsp" class="btn btn-primary form-control" >Add New Brand</a>
            </div>
            <div class="col-md-1">
                <a href="productaddsubcat.jsp" class="btn btn-info form-control" role="button">Back</a>
            </div> 
        </div>    
       </form>
      ...
      $(document).ready(function(){
         ...
         $.ajax({
           ...
           success: function (data, textStatus, jqXHR) {
                               j=JSON.parse(data);
                               $("#maincatforsubcat").empty();
                               $("#maincatforsubcat").append("<option selected disabled > Select a Main Category</option>");
                             for(var i=0;i<j.length;i++){
                               $("#maincatforsubcat").append("<option value='"+j[i].pc1id+"'>"+j[i].mctitle+"</option>");
                           }
