  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> 
        <div class="row">
              <div class="col-md-3">
        <small>Sub Category Management</small>
                </div>
            <div class="col-md-2">
                <form action="productaddsubcatadd.jsp">
                    <input type="submit" value="Add New Sub Category" class="btn btn-success form-control" />
                </form>
            </div>
        ...
        <li class="active">Sub Category Management</li>
      </ol>
    </section>
    ...
    <div class="container">
     <table id="example" class="display nowrap" width="100%" cellspacing="0">
        <thead>
           ...
           <tbody id="tabsubcat" name="tabsubcat">
<script src="plugins/jQuery/jquery-2.2.3.min.js"></script>
   
    <script>
        $(document).ready(function(){
           
        $.ajax({url:"http://localhost:8084/Subcat",
            method:"POST",
            success: function (data, textStatus, jqXHR) {
                        ...
                        $("#tabsubcat").append("<tr><td>"+j[i].Mcid+"<td>"+j[i].Title+"</td><td>"+j[i].SortOrder+"</td><td>"+j[i].Visible+"</td><td><input type='button' class='btn btn-primary btn-sm' value='Modify'></td><td><input type='button' class='btn btn-danger btn-sm' value='Remove'></td></tr>");
                        }
                    },
