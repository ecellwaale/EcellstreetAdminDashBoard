...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> <div class="row">
              <div class="col-md-3">
        <small>Main Category Management</small>
                </div>
            <div class="col-md-2">
                <form action="productaddmaincatadd.jsp">
                <input type="submit" value="Add New Main Category" class="btn btn-success form-control" />
                </form>
            </div>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Main Category Management</li>
      </ol>
    </section>
    ...
    <div class="container">
     <table id="example" class="display nowrap" width="100%" cellspacing="0">
       ...
       <tbody id="tabmaincat" name="tabmaincat">
   
    <script>
        $(document).ready(function(){
        $.ajax({url:"http://localhost:8084/Maincat",
            method:"POST",
            success: function (data, textStatus, jqXHR) {
                        ...
                        $("#tabmaincat").append("<tr><td>"+j[i].Title+"<td>"+j[i].ImageName+"</td><td>"+j[i].SortOrder+"</td><td>"+j[i].Visible+"</td><td><input type='button' class='btn btn-primary btn-sm' value='Modify'></td><td><input type='button' class='btn btn-danger btn-sm' value='Remove'></td></tr>");
                        }
                    },
