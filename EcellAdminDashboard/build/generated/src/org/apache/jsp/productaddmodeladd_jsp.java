...
public final class productaddmodeladd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("         $(\"#subcatformodels\").empty();\n");
      out.write("         $(\"#brandformodels\").empty();\n");
      out.write("         $.ajax({\n");
      out.write("             url:\"http://localhost:8080/NewServlet1\",\n");
      out.write("             data: {'status':'getmc'},\n");
      out.write("             success:function(data){\n");
      out.write("                        j=JSON.parse(data);\n");
      out.write("                        $(\"#maincatformodels\").empty();\n");
      out.write("                        \n");
      out.write("                        for(var i=0;i<j.length;i++)\n");
      out.write("                        {\n");
      out.write("                            \n");
      out.write("                            $(\"#maincatformodels\").append(\"<option value='\"+j[i].pc1id+\"'>\"+j[i].mctitle+\"</option>\");\n");
      out.write("                        }\n");
      out.write("                        \n");
      out.write("                    },\n");
      ...
      out.write("         })\n");
      out.write("\n");
      out.write("        $(\"#maincatformodels\").change(function(){\n");
      out.write("\n");
      out.write("\t\t\n");
      out.write("               selected=$(\"#maincatformodels option:selected\").val();\n");
      out.write("                \n");
      out.write("                $.ajax({\n");
      out.write("                    \n");
      out.write("                    url:\"http://localhost:8080/NewServlet1\",\n");
      ...
      out.write("                        {\n");
      out.write("                            \n");
      out.write("                            $(\"#subcatformodels\").append(\"<option value='\"+j2[x].pc2id+\"'>\"+j2[x].sctitle+\"</option>\");\n");
      out.write("                        }\n");
      out.write("                    },\n");
      out.write("                    error:function(err){\n");
      out.write("                        alert(\"error\"+err);\n");
      ...
      out.write("                })\n");
      out.write("                })\n");
      out.write("        $(\"#subcatformodels\").change(function(){\n");
      out.write("\n");
      out.write("\t\t\n");
      out.write("               selected=$(\"#subcatformodels option:selected\").val();\n");
      out.write("                \n");
      out.write("                $.ajax({\n");
      out.write("                    \n");
      out.write("                    url:\"http://localhost:8080/NewServlet1\",\n");
      ...
      out.write("                        {\n");
      out.write("                            \n");
      out.write("                            $(\"#brandformodels\").append(\"<option value='\"+j2[x].pc3id+\"'>\"+j2[x].typetitle+\"</option>\");\n");
      out.write("                        }\n");
      out.write("                        \n");
      out.write("                    },\n");
      out.write("                    error:function(err){\n");
      ...
      out.write("                 <li   class=\"active\"><a href=\"productaddmodel.jsp\">Product Model</a></li>\n");
      ...
      out.write("             </div>\n");
      out.write("             <div align=\"center\" style=\"\" class=\"col-md-4 center\">\n");
      out.write("                 <h4>Add Models</h4>\n");
      out.write("             </div>\n");
      out.write("             <div align=\"center\" style=\"\" class=\"col-md-4 center\">\n");
      out.write("                 \n");
      out.write("             </div>   \n");
      out.write("         </div>\n");
      out.write("        <form action=\"productaddmaincatadd.jsp\" method=\"post\">\n");
      out.write("        <div style=\"margin-top: 10px;\" class=\"row form-group\">\n");
      out.write("            <div align=\"center\" style=\"\" class=\"col-md-4 center\">\n");
      out.write("            </div>   \n");
      out.write("            <div class=\"col-md-4\">\n");
      out.write("                <label for=\"maincatformodels\">Select Main Category</label>\n");
      out.write("                <select class=\"form-control\" id=\"maincatformodels\">\n");
      ...
      out.write("            </div>   \n");
      out.write("            <div class=\"col-md-4\">\n");
      out.write("                <label for=\"subcatformodels\">Select Sub Category</label>\n");
      out.write("                <select class=\"form-control\" id=\"subcatformodels\">\n");
      out.write("                 <option value=\"volvo\">Volvo</option>\n");
      out.write("                 <option value=\"saab\">Saab</option>\n");
      out.write("                 <option value=\"mercedes\">Mercedes</option>\n");
      out.write("                 <option value=\"audi\">Audi</option>\n");
      ...
      out.write("            </div>   \n");
      out.write("            <div class=\"col-md-4\">\n");
      out.write("                <label for=\"brandformodels\">Select Brand</label>\n");
      out.write("                <select class=\"form-control\" id=\"brandformodels\">\n");
      out.write("                 <option value=\"volvo\">Volvo</option>\n");
      out.write("                 <option value=\"saab\">Saab</option>\n");
      out.write("                 <option value=\"mercedes\">Mercedes</option>\n");
      out.write("                 <option value=\"audi\">Audi</option>\n");
      ...
      out.write("                <input type=\"text\" class=\"form-control\" id=\"brand\" required/>\n");
      out.write("            </div>\n");
      out.write("            <div align=\"center\" style=\"\" class=\"col-md-4 center\">\n");
      out.write("            </div>   \n");
      out.write("        </div>\n");
      ...
      out.write("            </div>   \n");
      out.write("            <div class=\"col-md-4\">\n");
      out.write("                <label for=\"modelsortorder\">Sort Order</label>\n");
      out.write("                <input type=\"number\" class=\"form-control\" id=\"modelsortorder\" required/>\n");
      out.write("            </div>\n");
      out.write("            <div align=\"center\" style=\"\" class=\"col-md-4 center\">\n");
      out.write("            </div>   \n");
      out.write("        </div>\n");
      ...
      out.write("            </div>   \n");
      out.write("            <div class=\"col-md-4\">\n");
      out.write("                <label for=\"modelimage\">Image name</label>\n");
      out.write("                <input type=\"text\" class=\"form-control\" id=\"modelimage\" required/>\n");
      out.write("            </div>\n");
      out.write("            <div align=\"center\" style=\"\" class=\"col-md-4 center\">\n");
      out.write("            </div>   \n");
      out.write("        </div>\n");
      ...
      out.write("            </div>   \n");
      out.write("            <div class=\"col-md-4\">\n");
      out.write("                <label for=\"modelvisible\">Visible</label>\n");
      out.write("                   <div class=\"radio\">\n");
      out.write("                     <label><input type=\"radio\" name=\"modelvisible\">Yes</label>\n");
      out.write("                   </div>\n");
      out.write("                   <div class=\"radio\">\n");
      out.write("                     <label><input type=\"radio\" name=\"modelvisible\">No</label>\n");
      out.write("                   </div>\n");
      out.write("                   \n");
      out.write("            </div>\n");
      out.write("            <div align=\"center\" style=\"\" class=\"col-md-4 center\">\n");
      ...
      out.write("            </div>   \n");
      out.write("            <div class=\"col-md-2\">\n");
      out.write("                <input type=\"submit\" value=\"Add\" class=\"btn btn-success form-control\" />\n");
      out.write("            </div>\n");
      out.write("            <div class=\"col-md-3\">\n");
      out.write("                <a href=\"productaddproduct.jsp\" class=\"btn btn-primary form-control\" role=\"button\">Add Products</a>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"col-md-1\">\n");
      out.write("                <a href=\"productaddmodel.jsp\" class=\"btn btn-info form-control\" role=\"button\">Back</a>\n");
      out.write("            </div> \n");
      out.write("        </div>    \n");
      out.write("       </form>\n");
      out.write("  \n");
